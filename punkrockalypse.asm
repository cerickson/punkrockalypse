...
gamestate .rs 1; game state storage
butchx .rs 1 ; butch horizontal position
butchy .rs 1 ; butch vertical position
grimx .rs 1 ; grim horizontal position
grimy .rs 1 ; grim vertical position

buttons1 .rs 1 ; player one gamepad buttons
buttons2 .rs 1 ; player one gamepad buttons
scrollnow .rs 1 ; variable to check for scrolling 
...
; Read and process controller data
...
.include "player1_move.asm"
.include "player2_move.asm"
...
; moveloopUp:
;  lda $0200, x       ; load sprite X position ($0200 + x)
...
;  inx
;  inx
;  cpx #$4f           ; if x = $0f, all 4 sprites have been moved
...
; moveloopLeft:
;  lda $0200, x       ; load sprite X position ($2000 + x)
;  sec                ; make sure the carry flag is clear
;  sbc #$01           ; A = A + 1
;  sta $0200, x       ; save sprite X position
;  inx                ; increment X 4 times to get to next sprite
...
;  inx
;  cpx #$4f           ; if x = $0f, all 4 sprites have been moved
;  bne moveloopLeft       ; otherwise keep going.
...
palette:
  ...
  .db $0F,$1C,$17,$39,$31,$02,$38,$3C,$0F,$1C,$15,$14,$31,$02,$38,$3C
...
sprites:
  ...
  .db $96, $30, $00, $80   ;sprite 4
  .db $96, $31, $00, $88   ;sprite 5
...
;;;;;;;;;;;;;;  
  ...
  .bank 2
  .org $0000
  .incbin "Grim.chr"   ;includes 8KB graphics file from SMB1